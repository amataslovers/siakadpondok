                ...
                <tbody>
                    @foreach ($murid as $key => $value)
                        <tr>
                            ...
                            @if ($cat == 1 || $cat == 3)
                                <td>{!! Form::number('NILAI_UTS', null, ['class' => 'form-control', 'name' => 'NILAI_UTS[]', 'step' => 'any', 'required']) !!}</td>
                            @endif
                            @if ($cat == 2 || $cat == 3)
                                <td>{!! Form::number('NILAI_UAS', null, ['class' => 'form-control', 'name' => 'NILAI_UAS[]', 'step' => 'any', 'required']) !!}</td>
                            @endif
                        </tr>
