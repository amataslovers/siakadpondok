...
class KenaikanKelasController extends Controller
{
    public function index(Request $request)
    {
        ...
        $semester = Semester::whereHas('tahunAjaran', function($q){$q->where('STATUS', 1);})
                            ->orderBy('SEMESTER', 'asc')
                            ->select('ID_SEMESTER')
                            ->get();

        $pengampu = Pengampu::whereHas('tahunAjaran', function($q){$q->where('STATUS', 1);})
    ...
    public function prosesNaikKelas(Request $request)
    {
        ...
        try {
            ...
            $dataSemesterLama = Semester::whereHas('tahunAjaran', function($q){$q->where('STATUS', 1);})->where('STATUS', 1)->first();
            ...
            $dataTingkat = Tingkat::orderBy('TINGKAT', 'asc')->get();
